...
const SearchForm = dynamic(() => import('./SearchForm'), { 
    ssr: false,
    loading: () => <div className="w-full h-10 bg-gray-100 rounded-full animate-pulse" />
});
...
export default function Navbar({ categoriesData = [] }: { categoriesData: Category[] }) {
    ...
    const mainCategories = [...categoriesData].sort((a, b) => a.ordem - b.ordem).slice(0, 6);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-30 bg-white">
                <div className="flex justify-between items-center h-16 lg:h-20 gap-4">
                    <div className="flex-shrink-0">
                        <a href="/" className="text-xl md:text-2xl font-black text-blue-600 uppercase">Ecommerce</a>
                    </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-5 text-gray-600">
                        <button className="hidden sm:flex items-center gap-2 hover:text-blue-600">
                            <User size={20} />
                        ...
                        <button className="relative p-2 hover:bg-gray-100 rounded-full"><ShoppingCart size={24} /></button>
